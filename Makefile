...
global_src_dir = $(core_src_dir)/global-6.6.13
global_dest_dir = $(build_dir)/SOURCES/global-6.6.13
...
build_global:
	...
	@(cd $(build_dir)/SOURCES; tar zcvf $(global).tar.gz $(global); rm -rf $(global))
